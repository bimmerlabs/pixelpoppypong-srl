...
namespace Dialog
{
    inline void InitPennyDialog()
    {
              ...
              [CHARACTER_POTTER] =
        {
            ...
            "Magic or not-\nroyalty reigns.",                     // lose: Potter taunts you
              ...
              [CHARACTER_POPPY] =
        {
            ...
            "One crown. One queen.\n\nLesson learned.",              // lose: Poppy taunts you
              ...
              [CHARACTER_TJ] =
        {
            ...
            "Even the streets\nbow to the crown.",                 // lose: TJ taunts you
            "Pfft. I'm not royalty,\nbut I demand respect!",                  // win: TJ reacts to losing
              ...
              [CHARACTER_GEORGE] =
        {
            ...
            "Focus is the mark\nof a champion.",                   // lose: George taunts you
            "I lost because of the crown.\nIt sparkled at me!",   // win: George reacts to losing
            "So Shiny!!",
            "I got the ball!!",
        };
              ...
              [CHARACTER_WUPPY] =
        {
            ...
            "I'M SORRY ABOUT THE CROWN!!\nIT'S STILL PRETTY!!",   // win: Wuppy reacts to losing
              ...
              [CHARACTER_GARF] =
        {
            ...
            "He was half asleep. Undignified.",   // win: Garfield reacts to losing
            "Royalty is no match for pure laziness.",                  // lose: Garfield taunts you
